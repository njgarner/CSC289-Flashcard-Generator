...
urlpatterns = [
    ...
    path('password_reset/', auth_views.PasswordResetView.as_view(
        ...
        email_template_name='mysite/templates/registration/password_reset_email.html',
        subject_template_name='mysite/templates/registration/password_reset_subject.txt',
        success_url='/password_reset_done/'
    ), name='password_reset'),
    path('password_reset_done/', auth_views.PasswordResetDoneView.as_view(
        template_name='mysite/templates/registration/password_reset_done.html'
    ), name='password_reset_done'),
    path('reset/<uidb64>/<token>/', auth_views.PasswordResetConfirmView.as_view(
        template_name='mysite/templates/registration/password_reset_confirm.html',
        success_url='/password_reset_complete/'
    ), name='password_reset_confirm'),
    path('password_reset_complete/', auth_views.PasswordResetCompleteView.as_view(
        template_name='mysite/templates/registration/password_reset_complete.html'
