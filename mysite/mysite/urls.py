...
urlpatterns = [
    ...
    path(
        "delete_set/<int:set_id>/", views.delete_set, name="delete_set"
    ),  # Ensure consistency here
    path("library/", views.library_view, name="library_view"),
    path("settings/", views.settings, name="settings"),
    path(
        "flashcard-set/<int:set_id>/",
        views.view_flashcard_set,
    ...
    path(
        "flashcards/<int:set_id>/details/",
        views.get_flashcard_set_details,
        name="flashcard_set_details",
    ),
    path("change_password/", views.change_password, name="change_password"),
    path(
        "password_change_done/", views.password_change_done, name="password_change_done"
    ),
    path(
        "password_reset/",
